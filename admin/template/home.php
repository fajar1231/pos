...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header" style="background-color: #5a3e2b; color: white;">
...
<div class="card-footer" style="background-color: #5a3e2b; color: #ffffff;">
    <a href='index.php?page=barang' style="color: #ffffff;">Tabel
...
<div class="card-footer" style="background-color: #5a3e2b; color: #ffffff;">
    <a href='index.php?page=laporan' style="color: #ffffff;">Tabel
        Kategori <i class='fa fa-angle-double-right'></i></a>
</div>
        </div>
        <!--/rgb-card -->
...
<div class="card-footer" style="background-color: #5a3e2b; color: #ffffff;">
    <a href='index.php?page=kategori' style="color: #ffffff;">Tabel
        Kategori <i class='fa fa-angle-double-right'></i></a>
</div>
