...
?>
<a href="index.php?page=barang" class="btn mb-3" style="background-color: #5a3e2b; color: white; border-color: #5a3e2b;">
		...
		<table class="table table-striped">
			<form action="fungsi/edit/edit.php?barang=edit" method="POST">
				...
				<tr>
					<td></td>
<td>
    <button class="btn" style="background-color: #8b4513; color: white; border-color: #8b4513;">
