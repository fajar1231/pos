...
<head>
    ...
    <style>
        .bg-dark-brown {
            background-color: #5a3e2b; /* Coklat tua */
        }
        ...
        .btn-dark-brown:hover {
            background-color: #5a2c0e; /* Warna lebih gelap saat hover */
            border-color: #5a2c0e;
        }
    </style>
</head>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="p-5">
                            ...
                            <form class="form-login" method="POST">
                                ...
                                <button class="btn btn-dark-brown btn-block" name="proses" type="submit">
